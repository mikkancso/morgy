...
class TestFunctionality(unittest.TestCase):
    ...
    def test_file_is_created(self):
        self.ps.write_recommendations('/home/adatok/mp3Miki/01 Külföldi Punk/Bad Religion', '/tmp/test01')
...
class TestHelperFunctions(unittest.TestCase):
    ...
    def test_upper_first_and_all_before_dot(self):
        self.assertEqual(self.ps.upper_first_and_all_after_dot('42 i dont want to be a member of a.b.c. anymore.mp3'),
            '42 I dont want to be a member of A.B.C. anymore.mp3')

    @unittest.skip("feature request")
    def test_upper_all_after_dot(self):
        self.assertEqual(self.ps.upper_first_and_all_after_dot('42 mr. clean.mp3'), '42 Mr. Clean.mp3')

    def test_dashes_are_removed(self):
        self.assertTrue('-' not in self.ps.handle_dash_and_underscore('04._The_Doors_-_The_Soft_Parade_-_Do_It.mp3'))

    def test_underscores_are_removed(self):
        self.assertTrue('_' not in self.ps.handle_dash_and_underscore('04._The_Doors_-_The_Soft_Parade_-_Do_It.mp3'))

    def test_correct_spaces_if_does_not_start_with_digits(self):
        self.assertEqual(self.ps.correct_spaces('The  hey-a-ho   cookoo  .mp3'), 'The hey-a-ho cookoo.mp3')

    def test_correct_spaces_if_no_space_follows_digits(self):
        self.assertEqual(self.ps.correct_spaces('02The  hey-a-ho   cookoo  .mp3'), '02 The hey-a-ho cookoo.mp3')

    def test_correct_spaces_if_dot_follows_digits(self):
        self.assertEqual(self.ps.correct_spaces('02.The  hey-a-ho   cookoo  .mp3'), '02 The hey-a-ho cookoo.mp3')
