...
class Integrator:
    ...
    def move(self, folder):
        ...
        self.info[folder]['destination'] = real_folder.replace(self.to_integrate, self.info[folder]['path'])
    ...
    def run(self):
        ...
        self.path_sanitizer.write_recommendations(self.to_integrate, recommendations.name)
        input('The recommendations for renaming the files will be presented to you. Press enter to continue.')
...
def main():
    parser = argparse.ArgumentParser(description='Integrate new songs into your music folder and database.')
