...
def main():
    parser = argparse.ArgumentParser(description='Create a playlist by simply enumerating filepaths and write it to a file.')
    parser.add_argument('-f', '--file', help='The target playlist filename.')
    parser.add_argument('-s', '--selection', help='The selection whose results will be written to the file (the WHERE clause in the query).')
